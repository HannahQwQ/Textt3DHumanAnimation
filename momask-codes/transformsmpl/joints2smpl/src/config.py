...
GMM_MODEL_DIR = "./transformsmpl/joints2smpl/smpl_models/"
SMPL_MEAN_FILE = "./transformsmpl/joints2smpl/smpl_models/neutral_smpl_mean_params.h5"
# for collsion 
Part_Seg_DIR = "./transformsmpl/joints2smpl/smpl_models/smplx_parts_segm.pkl"